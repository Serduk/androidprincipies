...
public class BoundServiceCheckActivity extends AppCompatActivity {
    BoundService mBound;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bound_service_check);
        ...
        printTimestampButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mServiceBound) {
                    timestampText.setText(mBound.getTimestamp());
                }
            }
        });
        ...
        stopServiceButon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(BoundServiceCheckActivity.this,
                        BoundService.class);
                stopService(intent);
            }
        });
